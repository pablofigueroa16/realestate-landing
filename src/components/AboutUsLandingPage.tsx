    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative container mx-auto px-6 md:px-12 py-32 md:py-40">
        <div className="max-w-4xl">
          <span className="inline-block bg-white/10 border border-white/10 text-white text-[10px] font-bold tracking-[0.2em] px-4 py-2 rounded-full uppercase mb-8">
