...
export default function Footer() {
  ...
  return (
    <footer id="contacto" className="w-full bg-gray-50 flex flex-col justify-between p-4 md:p-6 lg:h-screen lg:overflow-hidden">
      {/* Contact Card */}
      <div className="w-full bg-white rounded-[2rem] md:rounded-[3rem] shadow-sm p-8 md:p-12 lg:p-20 lg:grow lg:flex lg:flex-col lg:justify-center mb-4 md:mb-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-24">
          {/* Left Column: Info */}
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-medium text-gray-900 mb-4 md:mb-8">
              {t("footer.contact.title")}
            </h2>
            <p className="text-gray-500 text-base md:text-lg leading-relaxed mb-8 md:mb-12 max-w-md font-light">
              {t("footer.contact.description")}
            </p>

            <div className="space-y-5 md:space-y-8">
              <div className="flex items-center gap-4 group cursor-pointer">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full border border-gray-200 flex items-center justify-center text-gray-900 group-hover:border-gray-900 transition-colors shrink-0">
                  <Mail size={18} />
                </div>
                <div>
          ...
          <div className="flex flex-col justify-center">
            <div className="space-y-4 md:space-y-6 w-full max-w-lg mx-auto lg:mx-0">
      ...
      {/* Bottom Bar */}
      <div className="flex flex-col md:flex-row justify-between items-center px-4 md:px-8 pb-2 text-gray-500 text-sm gap-4 md:gap-0">
