...
const CATEGORY_LABELS = {
  ...
  art_lifestyle: { es: "Arte y Lifestyle", en: "Art & Lifestyle" },
  culture_lifestyle: { es: "Cultura y Lifestyle", en: "Culture & Lifestyle" },
  sport: { es: "Deporte", en: "Sports" },
  residential: { es: "Residencial", en: "Residential" },
  premium_area: { es: "Zona Premium", en: "Premium Area" },
...
const CATEGORY_ALIASES: Record<string, keyof typeof CATEGORY_LABELS> = {
  ...
  "financial": "finance",
  "lifestyle": "lifestyle",
  "arte y lifestyle": "art_lifestyle",
  "art & lifestyle": "art_lifestyle",
  "cultura y lifestyle": "culture_lifestyle",
  "culture & lifestyle": "culture_lifestyle",
  "deporte": "sport",
  "sports": "sport",
  "residencial": "residential",
  "residential": "residential",
  "zona premium": "premium_area",
  "premium area": "premium_area",
