                    ...
                    >
                        <div className="bg-white p-4 rounded-4xl shadow-xl hover:shadow-2xl transition-shadow duration-300 flex flex-col h-full group">
                            ...
                            <div className="px-2 pb-2 grow flex flex-col">
                                ...
                                <a 
                                    href={`https://wa.me/971543034346?text=${encodeURIComponent("Hola, estoy interesado en recibir todos los detalles sobre esta propiedad y oportunidades similares actualmente disponibles. Por favor, inclúyeme precios actualizados, plan de pago, expectativas de retorno (ROI), disponibilidad y opciones para agendar una visita.")}`}
                                    target="_blank"
